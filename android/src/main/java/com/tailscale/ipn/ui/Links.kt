...
object Links {
  const val DEFAULT_CONTROL_URL = "https://headplane.tqhyg.net"
  const val SERVER_URL = "https://headscale.tqhyg.net"
  const val ADMIN_URL = SERVER_URL + "/ouroboros"
  const val SIGNIN_URL = "https://headscale.tqhyg.net/register"
